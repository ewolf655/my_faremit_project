...
import { checkUser } from "@/components/helpers";
                      ...
                      {user && data.verificationStatus === false ? (
                        <div className="flex  mb-3 space-x-2">
                          ...
                          <div
                            ...
                            role="alert"
                          >
                            <span className="font-medium">Not Verefied!</span>{" "}
                        ...
                        <div className="flex  mb-3 space-x-2">
                          ...
                          <div
                            ...
                            role="alert"
                          >
                            <span className="font-medium">Veriffied!</span> do
                            not hasitate sending money with your loved ones
                            again.
                          </div>
                          {/* <div className="m-2">
                                            <Language />{" "}
