      ...
      <div className="relative">
        <input
          ...
          className={`transition-all duration-300 ${
            ...
            large && "py-20"
          } focus:ring ${type === "password" ? " pr-10" : ""}`}
      ...
      <div className="relative">
        <input
          className={`transition-all duration-300  mt-2 py-2.5 px-4 w-full ${
            errors.length > 0
              ? "border-primary-400 focus:border-secondary-500 focus:ring-secondary-400-500/20"
...
export const Selection = (props) => {
  ...
  return (
    <div className="flex space-x-3 space-y-6 items-center max-w-full">
      {/* input send */}
      <div className="flex justify-between items-center flex-grow-0 flex-shrink-0 w-full h-full  md:px-5 rounded-xl bg-white border border-[#c7c4d4]">
