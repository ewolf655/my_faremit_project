...
function AuthSlider() {
    ...
    return (
        <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex   relative flex-col   justify-center max-h-[816px] max-md:mt-10 max-md:max-w-full">
                <img
                    loading="lazy"
                ...
                <div className="flex mt-24 md:mt-0 overflow-hidden relative flex-col px-8 py-10 w-full min-h-[816px] max-md:px-5 max-md:max-w-full">
                    <div className="flex relative flex-col justify-between p-4 mt-96 bg-[#f6e2f6] rounded-xl backdrop-blur-lg max-md:mt-10 max-md:max-w-full">
                        <h2 className="text-3xl font-semibold text-slate-900 max-md:max-w-full">
                            Secure Remittances, Seamless Transfers
                        </h2>
                        <p className="mt-4 text-base font-medium tracking-wider leading-7 text-primary max-md:max-w-full">
