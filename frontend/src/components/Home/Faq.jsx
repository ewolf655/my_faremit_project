...
const FAQ = () => {
    ...
    return (
        <div className="mt-20 border-t border-gray-200 bg-[#FFF5F1]">
            <div className="flex flex-col    items-left max-w-5xl mx-auto justify-center   ">
                <h1>Beyond Transactions, Building Trust</h1>
                <p>
            ...
            <div className="mx-auto w-full max-w-screen-xl mt-3 px-2.5 md:px-20 my-20">
                <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
                    <div className="p-3">
                        <img src="/images/frq.png" alt="" />
                    </div>
                    <div className="col-span-2 mt-10 px-3 sm:px-0">
                        {" "}
                        <h1 className="font-semibold">Frequently Asked Questions</h1>
                        {faqs.map((faq, index) => (
                            <div key={index} className="mb-6">
                                <div
                                    className="cursor-pointer  gap-4 space-x-10 flex justify-between items-center"
                                    onClick={() => handleToggle(index)}
                                >
                                    <h3 className="text-left text-lg mt-5 border-b-gray-400">
                                        {faq.question}
                                    </h3>
                                    <svg
